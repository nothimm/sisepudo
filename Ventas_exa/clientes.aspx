...
<body>
    ...
    <form id="form1" runat="server" role="form">
        <div class="form-control"><h1> Clientes</h1></div>
        <div class="form-control"><asp:Label ID="lbl_rut_cliente" runat="server" Text="Rut"></asp:Label>&nbsp; <asp:TextBox ID="txt_rut" runat="server"></asp:TextBox></div>
        <div class="form-control"><asp:Label ID="nombre" runat="server" Text="nombre"></asp:Label> &nbsp;<asp:TextBox ID="txt_nom_cliente" runat="server"></asp:TextBox></div>
